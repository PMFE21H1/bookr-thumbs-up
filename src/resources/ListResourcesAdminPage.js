...
class listResourceAdminPage extends React.Component{
    ...
    render() {
      return (
        ...
        <Nav>
          <Nav.Item>
           <Nav.Link as={Link} to={`/admin/config/${taxonomy.url}/create`}>
  ...
  </svg> Add {taxonomy.resource}</Nav.Link>
        </Nav.Item>
        </Nav>
                ...
                return (
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <Link to={`/admin/config/${taxonomy.url}/${resource.id}/edit`}>
                          EDIT
                        </Link>
                      </td>
                      <td>
                        <Link to={`/admin/config/${taxonomy.url}/${resource.id}/delete`}>
                          DELETE
                        </Link>
                      </td>
                    </tr>
